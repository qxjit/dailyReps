module Year2020.Month04.Day15 where

trivialMaybe :: Maybe Integer
trivialMaybe =
  Just 10
...
promptUserWithSecret :: String -> String -> IO (Maybe String)
promptUserWithSecret secret prompt = do
  putStrLn "Before I ask you a question, you need to tell me the secret:"
  secretLine <- getLine
  ...
  if secretLine == secret
    then do
      ...
      putStrLn "Sorry, that wasn't the secret!"
      pure Nothing
